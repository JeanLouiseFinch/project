...
type ConnectorUseCase interface {
	Request(request *entities.Request) (bool, error)
}
...
// Request checking a request by ip login and passport
func (i *Connector) Request(request *entities.Request) (bool, error) {
