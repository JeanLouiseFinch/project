...
type AntiBruteForceClient interface {
	Check(ctx context.Context, in *Request, opts ...grpc.CallOption) (*StatusResponse, error)
...
func (c *antiBruteForceClient) Check(ctx context.Context, in *Request, opts ...grpc.CallOption) (*StatusResponse, error) {
...
type AntiBruteForceServer interface {
	Check(context.Context, *Request) (*StatusResponse, error)
...
func (*UnimplementedAntiBruteForceServer) Check(ctx context.Context, req *Request) (*StatusResponse, error) {
